<template>
    <Modal title="修改密码" v-model="visible" @on-cancel="hide">
        <Form :model="form" ref="form" :label-width="100" :rules="rules">
            <FormItem label="旧密码" prop="oldPwd">
                <Input type="password" v-model="form.oldPwd" autocomplete="off" />
            </FormItem>
            <FormItem label="新密码" prop="newPwd">
                <Input type="password" v-model="form.newPwd" autocomplete="off" />
            </FormItem>
            <FormItem label="确认新密码" prop="checkNewPwd">
                <Input type="password" v-model="form.checkNewPwd" autocomplete="off" />
            </FormItem>
        </Form>
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                checkNewPwd: [{ required: true, message: '确认密码不能为空' }, { validator: validatePassCheck }]
            },
            visible: false
        };
    },
